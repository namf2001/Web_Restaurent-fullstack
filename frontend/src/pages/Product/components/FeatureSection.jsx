        ...
        <div className="pb-16 sm:pb-20">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div className="mx-auto mt-10 grid max-w-lg grid-cols-1 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-2 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                    <div className="col-span-2 w-full object-contain lg:col-span-1 icon__cloud-item">
                        <BiTimer className="text-8xl text-slate-500 hover:text-primary-color" />
                    ...
                    <div className="col-span-2 w-full object-contain lg:col-span-1 icon__cloud-item">
                        <TbTruckDelivery className="text-8xl text-slate-500 hover:text-primary-color text-center" />
                        <span className="text-slate-400 font-bold">
                    ...
                    <div className="col-span-2 w-full object-contain lg:col-span-1 icon__cloud-item">
                        <BiSupport className="text-8xl text-slate-500 hover:text-primary-color" />
                        <span className="text-slate-400 font-bold">
